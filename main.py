...
individual_bill_rounded = round(individual_bill, 2)

#Output of the amount that each person have to pay.
print(f"Each person should pay: ${individual_bill_rounded}")